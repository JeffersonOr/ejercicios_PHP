                ...
                <div class="container-fluid pr-5"> <!--exercise-->
                    <div class="row">
                        <div class="col-12 p-0">
                            <div class="p">Ejercicio 2: Imprime en pantalla la palabra SENA la cantidad veces que el
                                usuario digite por medio de un input </div>
                        </div>
                    </div>
                        ...
                        <div class="col-8">
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="basic-addon1">Digite la cantidad</span>
                                </div>
