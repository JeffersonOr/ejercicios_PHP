...
<head>
    ...
    if (isset($_POST['num'])) {
        ...
        if ($valorInput1 % 5 == 0) {
            echo "El numero ingresado es multiplo de 5";
            exit;
        } else {
            echo "El numero ingresado no es multiplo de 5";
            exit;
        }
        ...
        <div class="row">
            ...
            <div class="col-10 mt-2">
                <div class="container-fluid pr-5"> <!--exercise-->
                    <div class="row">
                        <div class="col-12 p-0">
                            <div class="p">Ejercicio 14: Determine si un numero es multiplo de 5 o no</div>
                        </div>
                    </div>
