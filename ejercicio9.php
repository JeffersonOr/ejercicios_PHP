...
<head>
    ...
    if (isset($_POST['num'])) {
        ...
        for ($i = 1; $i <= 20; $i++) {
            echo $valorInput1 . " x " . $i . " = " . $valorInput1 * $i . "<br>";
        }
        exit;
    }
    ?>
        ...
        <div class="row">
            ...
            <div class="col-10 mt-2">
                <div class="container-fluid pr-5"> <!--exercise-->
                    <div class="row">
                        <div class="col-12 p-0">
                            <div class="p">Ejercicio 9: Calcule la tabla de multiplicar desde el 1 hasta el 20 de
                                cualquier numero que solicite el usuario</div>
                        </div>
                    </div>
                        ...
                        <div class="col-8">
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="basic-addon1">Tabla de multiplicar</span>
                                </div>
