    ...
    if (isset($_POST['num1']) && isset($_POST['num2']) && isset($_POST['valButton'])) {
        ...
        */
        if ($valorInput1 > $valorInput2) {
            echo "El numero " . $valorInput1 . " es mayor";
            exit;
        } elseif ($valorInput1 < $valorInput2) {
            echo "El numero " . $valorInput1 . " es menor";
            exit;
        } else {
                ...
                <div class="container-fluid pr-5"> <!--exercise-->
                    <div class="row">
                        <div class="col-12 p-0">
                            <div class="p">Ejercicio 5: Realice un algoritmo que verifique entre dos numeros cual es
                                menor</div>
                        </div>
                    </div>
