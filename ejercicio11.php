        ...
        <div class="row">
            ...
            <div class="col-10 mt-2">
                <div class="container-fluid pr-5"> <!--exercise-->
                    <div class="row">
                        <div class="col-12 p-0">
                            <div class="p">Ejercicio 11: Se requiere un programa para validar si la contraseña ingresada
                                es correcta</div>
                        </div>
                    </div>
                    <div class="row mt-4 pr-5">
                        <div class="col-6">
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="basic-addon1">Contrseña</span>
                                </div>
                                <input id="num1" type="password" class="form-control" aria-label="Username"
                        ...
                        <div class="col-6">
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="basic-addon1">Validar contraseña</span>
                                </div>
                                <input id="num2" type="password" class="form-control" aria-label="Username"
                                    aria-describedby="basic-addon1">
                            </div>
                        </div>
                    </div>
